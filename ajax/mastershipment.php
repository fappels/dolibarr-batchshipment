...
/**
 *       \file       htdocs/batchshipment/ajax/mastershipment.php
 *       \brief      File to return Ajax response on mastershipment list request
 */
...
dol_syslog("Call ajax batchshipment/ajax/mastershipment.php");
