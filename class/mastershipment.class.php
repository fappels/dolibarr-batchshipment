...
class MasterShipment extends CommonObject
{
	...
	public $fields = array(
		...
		"ref" => array("type" => "varchar(128)", "label" => "Ref", "enabled" => "1", 'position' => 20, 'notnull' => 1, 'default'=>'(PROV)', "visible" => "1", "csslist" => "tdoverflowmax150", "showoncombobox" => "1",),
		...
		"value" => array("type" => "double", "label" => "Value", "enabled" => "1", 'position' => 30, 'notnull' => 0, "visible" => "-1",),
		"weight" => array("type" => "double", "label" => "Weight", "enabled" => "1", 'position' => 35, 'notnull' => 0, "visible" => "-1",),
		...
		"picking_progress" => array("type" => "double", "label" => "Pickingprogress", "enabled" => "0", 'position' => 50, 'notnull' => 0, "visible" => "-1",),
		"loading_progress" => array("type" => "double", "label" => "Loadingprogress", "enabled" => "0", 'position' => 55, 'notnull' => 0, "visible" => "-1",),
		"proof_uploaded" => array("type" => "int", "label" => "Proofuploaded", "enabled" => "0", 'position' => 60, 'notnull' => 0, "visible" => "-1",),
		...
		"date_creation" => array("type" => "datetime", "label" => "DateCreation", "enabled" => "1", 'position' => 90, 'notnull' => 1, "visible" => "-1",),
		"date_validation" => array("type" => "datetime", "label" => "DateValidation", "enabled" => "1", 'position' => 95, 'notnull' => 0, "visible" => "-1",),
		"date_pick" => array("type" => "datetime", "label" => "Datepick", "enabled" => "1", 'position' => 100, 'notnull' => 0, "visible" => "-1",),
		"date_load" => array("type" => "datetime", "label" => "Dateload", "enabled" => "1", 'position' => 100, 'notnull' => 0, "visible" => "-1",),
		"date_ship" => array("type" => "datetime", "label" => "Dateship", "enabled" => "1", 'position' => 105, 'notnull' => 0, "visible" => "-1",),
		"tms" => array("type" => "timestamp", "label" => "DateModification", "enabled" => "1", 'position' => 110, 'notnull' => 0, "visible" => "0",),
		"fk_user_creat" => array("type" => "integer:User:user/class/user.class.php", "label" => "UserAuthor", "picto" => "user", "enabled" => "1", 'position' => 115, 'notnull' => 1, "visible" => "-2", "css" => "maxwidth500 widthcentpercentminusxx", "csslist" => "tdoverflowmax150",),
		"fk_user_modif" => array("type" => "integer:User:user/class/user.class.php", "label" => "UserModif", "picto" => "user", "enabled" => "1", 'position' => 120, 'notnull' => -1, "visible" => "-2", "css" => "maxwidth500 widthcentpercentminusxx", "csslist" => "tdoverflowmax150",),
		"fk_user_valid" => array("type" => "integer:User:user/class/user.class.php", "label" => "UserValidation", "picto" => "user", "enabled" => "1", 'position' => 125, 'notnull' => 0, "visible" => "-1", "css" => "maxwidth500 widthcentpercentminusxx", "csslist" => "tdoverflowmax150",),
		"fk_user_pick" => array("type" => "integer:User:user/class/user.class.php", "label" => "UserPick", "picto" => "user", "enabled" => "1", 'position' => 127, 'notnull' => 0, "visible" => "-1", "css" => "maxwidth500 widthcentpercentminusxx", "csslist" => "tdoverflowmax150",),
		"fk_user_load" => array("type" => "integer:User:user/class/user.class.php", "label" => "UserLoad", "picto" => "user", "enabled" => "1", 'position' => 130, 'notnull' => 0, "visible" => "-1", "css" => "maxwidth500 widthcentpercentminusxx", "csslist" => "tdoverflowmax150",),
		"fk_user_ship" => array("type" => "integer:User:user/class/user.class.php", "label" => "UserShip", "picto" => "user", "enabled" => "1", 'position' => 135, 'notnull' => 0, "visible" => "-1", "css" => "maxwidth500 widthcentpercentminusxx", "csslist" => "tdoverflowmax150",),
