...
/**
 *  \file       mastershipment_note.php
 *  \ingroup    batchshipment
 *  \brief      Tab for notes on MasterShipment
 */
...
$langs->loadLangs(array("batchshipment@batchshipment", "companies"));
...
if ($id > 0 || !empty($ref)) {
	$upload_dir = $conf->batchshipment->multidir_output[empty($object->entity) ? $conf->entity : $object->entity]."/".$object->id;
}
...
$title = $langs->trans('MasterShipment').' - '.$langs->trans("Notes");
//$title = $object->ref." - ".$langs->trans("Notes");
$help_url = '';
//$help_url='EN:Customers_Orders|FR:Commandes_Clients|ES:Pedidos de clientes';

llxHeader('', $title, $help_url, '', 0, 0, '', '', '', 'mod-batchshipment page-card_notes');
...
if ($id > 0 || !empty($ref)) {
	...
	print dol_get_fiche_head($head, 'note', $langs->trans("MasterShipment"), -1, $object->picto);
