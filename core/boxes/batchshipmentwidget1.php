...
/**
 * \file    batchshipment/core/boxes/batchshipmentwidget1.php
 * \ingroup batchshipment
 * \brief   Widget provided by BatchShipment
 *
 ...
 */
class batchshipmentwidget1 extends ModeleBoxes
{
	/**
	 * @var string Alphanumeric ID. Populated by the constructor.
	 */
	public $boxcode = "batchshipmentbox";

	/**
	 * @var string Box icon (in configuration page)
	 * Automatically calls the icon named with the corresponding "object_" prefix
	 */
	public $boximg = "batchshipment@batchshipment";
	 ...
	 */
	public $lang = 'batchshipment@batchshipment';

	/**
	 * @var string[] Module dependencies
	 */
	public $depends = array('batchshipment');
	...
	public function __construct(DoliDB $db, $param = '')
	{
		...
		// $this->hidden = !$user->hasRight('batchshipment', 'mastershipment', 'read');
	}
	...
	public function loadBox($max = 5)
	{
		...
		//dol_include_once("/batchshipment/class/batchshipment.class.php");

		// Populate the head at runtime
		$text = $langs->trans("BatchShipmentBoxDescription", $max);
		$this->info_box_head = array(
			...
			'subpicto' => 'object_batchshipment@batchshipment',
