...
/**
 *  \file       core/modules/batchshipment/doc/pdf_standard.modules.php
...
/**
 *	Class to manage PDF template standard_mastershipment
 */
class pdf_standard_mastershipment extends ModelePDFMasterShipment
{
	/**
	...
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
		...
		if (getDolGlobalString('MASTERSHIPMENT_DRAFT_WATERMARK') && $object->status == $object::STATUS_DRAFT) {
			$this->watermark = getDolGlobalString('MASTERSHIPMENT_DRAFT_WATERMARK');
		}
		...
		/*
		if (getDolGlobalInt('MAIN_GENERATE_MASTERSHIPMENT_WITH_PICTURE'))) {
	 ...
	 *
	 *	@param	TCPDF|TCPDI	$pdf     		Object PDF
	 *	@param	MasterShipment	$object     	Object to show
	...
	protected function _pagehead(&$pdf, $object, $showaddress, $outputlangs, $outputlangsbis = null)
	{
		...
		// Show Draft Watermark
		if (getDolGlobalString('BATCHSHIPMENT_DRAFT_WATERMARK') && $object->status == $object::STATUS_DRAFT) {
			pdf_watermark($pdf, $outputlangs, $this->page_hauteur, $this->page_largeur, 'mm', dol_escape_htmltag(getDolGlobalString('BATCHSHIPMENT_DRAFT_WATERMARK')));
		}
