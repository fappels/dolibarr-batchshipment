...
/**
 *  \file       mastershipment_agenda.php
 *  \ingroup    batchshipment
 *  \brief      Tab of events on MasterShipment
 */
...
if ($id > 0 || !empty($ref)) {
	$upload_dir = $conf->batchshipment->multidir_output[!empty($object->entity) ? $object->entity : $conf->entity]."/".$object->id;
}
...
if ($object->id > 0) {
	$title = $langs->trans("MasterShipment")." - ".$langs->trans('Agenda');
	//$title = $object->ref." - ".$langs->trans("Agenda");
	$help_url = 'EN:Module_Agenda_En|DE:Modul_Terminplanung';

	llxHeader('', $title, $help_url, '', 0, 0, '', '', '', 'mod-batchshipment page-card_agenda');
	...
	print dol_get_fiche_head($head, 'agenda', $langs->trans("MasterShipment"), -1, $object->picto);
	...
	if (isModEnabled('agenda') && ($user->hasRight('agenda', 'myactions', 'read') || $user->hasRight('agenda', 'allactions', 'read'))) {
		...
		//$cachekey = 'count_events_mastershipment_'.$object->id;
