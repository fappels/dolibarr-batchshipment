...
/**
 *  \file       mastershipment_contact.php
 *  \ingroup    batchshipment
 *  \brief      Tab for contacts linked to MasterShipment
 */
...
$title = $langs->trans("MasterShipment")." - ".$langs->trans('ContactsAddresses');
//$title = $object->ref." - ".$langs->trans('ContactsAddresses');
$help_url = '';
//$help_url='EN:Module_Third_Parties|FR:Module_Tiers|ES:Empresas';
llxHeader('', $title, $help_url, '', 0, 0, '', '', '', 'mod-batchshipment page-card_contact');
...
if ($object->id) {
	...
	print dol_get_fiche_head($head, 'contact', $langs->trans("MasterShipment"), -1, $object->picto);
